...
**SSH Note:** SSH key auth from dev workstation fails (key not accepted). Use `sshpass -p '[See PASSWORDS.md]' ssh agamache@192.168.1.185` or fix authorized_keys on the VM.
