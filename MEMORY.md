...
🚨 **And the DHCP pool is NOT what it appears:** Andrew set it to `.221–.250`, yet the Denon was handed
**`.199`**. ⛔ **So an address below `.221` being quiet does NOT mean it is unallocated.** A sweep answers
*"who replies to ping"*, never *"what could be handed out tomorrow"*.
