...
| [**k8s-cka-prep**](k8s-cka-prep/README.md) | Kubernetes done properly: a five-node `kubeadm` cluster with an HA control plane behind kube-vip — built as a procedure to repeat at work — then used to drill the **CKA** curriculum one administrative task type per chapter | 1 written | **Yes** — five real kubeadm-ready nodes, built and verified | 🔵 In progress — Ch1 written, rest planned in [`phase18`](../phases/phase18_k8s_cka_build.md). ⚠️ Holds **exam research as well as chapters**, deliberately |
